...
def run():
	command = "../resources/filler_vm -p1 ../resources/players/\"{0}\".filler -p2 ../resources/players/\"{1}\".filler -v -f ../resources/maps/\"{2}\" | python3 visual.py".format(arr1[p1], arr1[p2], arr2[map_nro])
	os.system(command)
	pygame.quit()
